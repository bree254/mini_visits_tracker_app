...
num appWidth = Get.width;
num appHeight = Get.height;
...
class SizeUtils {
  ...
  static void setScreenSize(
    ...
    //   width =
    //       boxConstraints.maxWidth.isNonZero(defaultValue: appWidth);
    //   height = boxConstraints.maxHeight.isNonZero();
    // } else {
    //   width =
    //       boxConstraints.maxHeight.isNonZero(defaultValue: appWidth);
...
extension ResponsiveExtension on num {
  ...
  double get h => ((this * _width) / appWidth);

  /// This method is used to set padding/margin (for the top and bottom side) &
  /// height of the screen or widget according to the Viewport height.
  double get v => (this * _height) / (appHeight - defaultStatusBar);
